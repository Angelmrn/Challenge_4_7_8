...
public class Datos {
   ...
   public static ArrayList<Datos> DatTutors = new ArrayList<> ();
    ...
    public static ArrayList<Datos> SIMTutors(){
        SimulacionTutors.add(new Datos(-3,7.5));
        SimulacionTutors.add(new Datos(-2,3));
        SimulacionTutors.add(new Datos(-1,0.5));
        SimulacionTutors.add(new Datos(0,1));
        SimulacionTutors.add(new Datos(1,3));
        SimulacionTutors.add(new Datos(2,6));
        SimulacionTutors.add(new Datos(3,14));
